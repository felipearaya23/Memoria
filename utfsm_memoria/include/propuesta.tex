...
\multicolumn{1}{|c|}{B} & \multicolumn{1}{c|}{A} & \multicolumn{1}{c|}{N} & \multicolumn{1}{c|}{A} & \multicolumn{1}{c|}{N} & \multicolumn{1}{c|}{A} & \multicolumn{1}{c|}{-\textgreater} & \multicolumn{1}{c|}{B} & \multicolumn{1}{c|}{A} & \multicolumn{1}{c|}{N} & \multicolumn{1}{c|}{} & \multicolumn{1}{c|}{A} & \multicolumn{1}{c|}{N} & \multicolumn{1}{c|}{A} \\ \cline{1-6} \cline{8-10} \cline{12-14} 
\end{tabular}
...
$b)$ Avanzar y colocarse en \texttt{SA\textsubscript{XY}[3]}, e insertar elemento \texttt{SA\textsubscript{Y}[1]} $= 0$ en el arreglo, como \texttt{gap\textsubscript{X:Y}[1]} $= 0$, no se avanzan posiciones en el arreglo combinado y se inserta el elemento en \texttt{SA\textsubscript{XY}[3]}:
