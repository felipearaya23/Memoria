...
Actualmente está compuesta por 14.785 secuencias que equivalen a un texto con peso de 1.4 MB. Aunque son bastante pocas secuencias en función de UniProt, estos péptidos están descritos de manera muy completa y son ideales para realizar diferentes tipos de análisis, ya sea por propiedades regulatoriad en los seres vivos, propiedades físico-químicas, tipo de órgano en el cual se encuentran, entre otros.
